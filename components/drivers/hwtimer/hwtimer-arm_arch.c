...
static rt_uint64_t mon_ptimer_value(rt_uint64_t val)
{
    if (val)
    {
        sysreg_write(CNTPS_TVAL, val);
    }
    else
    {
        sysreg_read(CNTPS_TVAL, val);
    }
...
static rt_uint64_t hyp_s_ptimer_value(rt_uint64_t val)
{
    ...
    if (val)
    {
        sysreg_write(CNTHPS_TVAL, val);
    }
    else
    {
        sysreg_read(CNTHPS_TVAL, val);
    }
...
static rt_uint64_t hyp_ns_ptimer_value(rt_uint64_t val)
{
    if (val)
    {
        sysreg_write(CNTHP_TVAL, val);
    }
    else
    {
        sysreg_read(CNTHP_TVAL, val);
    }
...
static rt_uint64_t hyp_s_vtimer_value(rt_uint64_t val)
{
    ...
    if (val)
    {
        sysreg_write(CNTHVS_TVAL, val);
    }
    else
    {
        sysreg_read(CNTHVS_TVAL, val);
    }
...
static rt_uint64_t hyp_ns_vtimer_value(rt_uint64_t val)
{
    ...
    if (val)
    {
        sysreg_write(CNTHV_TVAL, val);
    }
    else
    {
        sysreg_read(CNTHV_TVAL, val);
    }
...
static rt_uint64_t os_ptimer_value(rt_uint64_t val)
{
    if (val)
    {
        sysreg_write(CNTP_TVAL, val);
    }
    else
    {
        sysreg_read(CNTP_TVAL, val);
    }
...
static rt_uint64_t os_vtimer_value(rt_uint64_t val)
{
    if (val)
    {
        sysreg_write(CNTV_TVAL, val);
    }
    else
    {
        sysreg_read(CNTV_TVAL, val);
    }
