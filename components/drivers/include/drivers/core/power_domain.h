...
struct rt_dm_power_domain_proxy
{
    ...
    struct rt_dm_power_domain *(*ofw_parse)(struct rt_dm_power_domain_proxy *,
...
struct rt_dm_power_domain
{
    ...
    rt_err_t (*power_on)(struct rt_dm_power_domain *);
    rt_err_t (*power_off)(struct rt_dm_power_domain *);
    rt_err_t (*attach_dev)(struct rt_dm_power_domain *, struct rt_device *);
    rt_err_t (*detach_dev)(struct rt_dm_power_domain *, struct rt_device *);
